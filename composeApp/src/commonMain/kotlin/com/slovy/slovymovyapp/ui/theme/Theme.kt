...
import slovymovyapp.composeapp.generated.resources.lora_variable
...
fun AppTheme(
    ...
    val loraRegular = Font(Res.font.lora_variable, FontWeight.Normal)
    val loraMedium = Font(Res.font.lora_variable, FontWeight.Medium)
    val loraSemiBold = Font(Res.font.lora_variable, FontWeight.SemiBold)
    val loraBold = Font(Res.font.lora_variable, FontWeight.Bold)
    val loraFamily = remember(loraRegular, loraMedium, loraSemiBold, loraBold) {
        FontFamily(loraRegular, loraMedium, loraSemiBold, loraBold)
    }
    val typography = remember(loraFamily) { appTypography(loraFamily) }
