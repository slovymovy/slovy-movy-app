...
val onPrimaryLight = Color(0xFF891A1A)
...
val onSecondaryLight = Color(0xFF801111)
val secondaryContainerLight = Color(0xFF618224)
val onSecondaryContainerLight = Color(0xFF404A33)
val tertiaryLight = Color(0xFF386663)
val onTertiaryLight = Color(0xFF9A2828)
val tertiaryContainerLight = Color(0xFF1CAA9B)
val onTertiaryContainerLight = Color(0xFF1F4E4B)
val errorLight = Color(0xFFBA1A1A)
val onErrorLight = Color(0xFF820505)
val errorContainerLight = Color(0xFF9A291C)
val onErrorContainerLight = Color(0xFF93000A)
val backgroundLight = Color(0xFFD0E311)
val onBackgroundLight = Color(0xFF1A1C16)
val surfaceLight = Color(0xFFC5D710)
val onSurfaceLight = Color(0xFF1A1C16)
val surfaceVariantLight = Color(0xFFBDE716)
val onSurfaceVariantLight = Color(0xFF44483D)
val outlineLight = Color(0xFF9CDB0F)
val outlineVariantLight = Color(0xFF9ABB20)
val scrimLight = Color(0xFF000000)
val inverseSurfaceLight = Color(0xFF2F312A)
val inverseOnSurfaceLight = Color(0xFFA5B314)
val inversePrimaryLight = Color(0xFFB1D18A)
val surfaceDimLight = Color(0xFFABBB0B)
val surfaceBrightLight = Color(0xFFCADC10)
val surfaceContainerLowestLight = Color(0xFFDE0A0A)
val surfaceContainerLowLight = Color(0xFFB8C907)
val surfaceContainerLight = Color(0xFFC5D513)
val surfaceContainerHighLight = Color(0xFFB4C418)
val surfaceContainerHighestLight = Color(0xFFCEE20F)

val primaryLightMediumContrast = Color(0xFF253D05)
val onPrimaryLightMediumContrast = Color(0xFFC41111)
val primaryContainerLightMediumContrast = Color(0xFF5A7539)
val onPrimaryContainerLightMediumContrast = Color(0xFFD70F0F)
val secondaryLightMediumContrast = Color(0xFF303924)
val onSecondaryLightMediumContrast = Color(0xFFEC0D0D)
val secondaryContainerLightMediumContrast = Color(0xFF667157)
val onSecondaryContainerLightMediumContrast = Color(0xFFDE0909)
val tertiaryLightMediumContrast = Color(0xFF083D3A)
val onTertiaryLightMediumContrast = Color(0xFFDB0C0C)
val tertiaryContainerLightMediumContrast = Color(0xFF477572)
val onTertiaryContainerLightMediumContrast = Color(0xFFD21D1D)
val errorLightMediumContrast = Color(0xFF740006)
val onErrorLightMediumContrast = Color(0xFFDE0606)
val errorContainerLightMediumContrast = Color(0xFFCF2C27)
val onErrorContainerLightMediumContrast = Color(0xFFD70404)
val backgroundLightMediumContrast = Color(0xFFC4D512)
val onBackgroundLightMediumContrast = Color(0xFF1A1C16)
val surfaceLightMediumContrast = Color(0xFFD7EA13)
val onSurfaceLightMediumContrast = Color(0xFF0F120C)
val surfaceVariantLightMediumContrast = Color(0xFFA5CB0C)
...
val inverseOnSurfaceLightMediumContrast = Color(0xFFD4E517)
val inversePrimaryLightMediumContrast = Color(0xFFB1D18A)
val surfaceDimLightMediumContrast = Color(0xFFBED01B)
val surfaceBrightLightMediumContrast = Color(0xFFD6EA10)
val surfaceContainerLowestLightMediumContrast = Color(0xFFDB0F0F)
val surfaceContainerLowLightMediumContrast = Color(0xFFD4E717)
val surfaceContainerLightMediumContrast = Color(0xFFCBDC1A)
val surfaceContainerHighLightMediumContrast = Color(0xFFB7DC11)
val surfaceContainerHighestLightMediumContrast = Color(0xFFB9DE12)
